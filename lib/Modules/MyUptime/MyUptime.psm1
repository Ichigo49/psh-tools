...
Function Get-MyUptime {
    <#
        ...
        The command includes custom format and type extensions with predefined table and list views. 
        The function writes a custom object to the pipeline which includes several custom methods so that you can get additional time-related information. 
        See examples.

        The uptime information is calculated via a set of script properties. 
        When you run the command and save the results to a variable, you will get updated information every time you look at the variable.
        .Parameter Computername
        The name of the computer to query. This parameter has an alias of CN and Name. 
