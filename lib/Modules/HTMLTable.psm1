...
function ConvertTo-PropertyValue {
    ...
    .EXAMPLE
    get-process powershell | convertto-propertyvalue

    I want details on the powershell process.
    ...
    #Add property value table showing details for PowerShell ISE
        ...
        $processDetails = Get-process powershell | select name, id, cpu, handles, workingset, PrivateMemorySize, Path -first 1
