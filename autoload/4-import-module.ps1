...
if ($psversiontable.PSVersion.Major -ge 3 -and (Get-WmiObject win32_operatingsystem).version -lt 10) {
    ...
    #region   Optimisation PSReadLine
    ...
    Set-PSReadlineKeyHandler -Key Shift+Alt+LeftArrow -Function SelectShellBackwardWord
    Set-PSReadlineKeyHandler -Key Shift+Alt+RightArrow -Function SelectShellForwardWord
    ...
    #endregion   Optimisation PSReadLine
}